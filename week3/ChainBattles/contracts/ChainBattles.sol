...
contract ChainBattles is ERC721URIStorage/// @notice 
/// @dev Explain to a developer any extra details
{
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory)
    {
        ...
        return string(abi.encodePacked("data:image/svg+xml;base64,",Base64.encode(svg)));//to turn svg code into a string so that contract can handle it 
    }
    ...
    {
        require(ownerOf(tokenId)==msg.sender,"Only owners train their tokens");
